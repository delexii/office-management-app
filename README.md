...
- [x] the user can leave a meeting room and render this available for others
- [x] the user can see a list of available rooms in the office
- [x] the user can attempt to enter a meeting room that is in use and it will be shown an error
